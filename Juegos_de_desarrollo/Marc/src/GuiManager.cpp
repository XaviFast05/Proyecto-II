...
GuiControl* GuiManager::CreateGuiControl(GuiControlType bullet_direction, const char* name, const char* text, SDL_Rect bounds, Module* _observer, SDL_Rect sliderBounds, SDL_Texture* tex, SDL_Texture* sliderTex)
