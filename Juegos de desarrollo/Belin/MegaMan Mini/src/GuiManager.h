...
public:
	...
	GuiControl* CreateGuiControl(GuiControlType type, int id, const char* text, SDL_Texture* texture, SDL_Rect bounds, Module* observer, SDL_Rect sliderBounds = { 0,0,0,0 });
