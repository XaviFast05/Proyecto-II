...
SoulRockParticle::SoulRockParticle() : Entity(EntityType::PARTICLE)
{
...
bool SoulRockParticle::Start() {
	...
	pbody = Engine::GetInstance().physics.get()->CreateCircleSensor((int)position.getX(), (int)position.getY(), shotRad, bodyType::STATIC);
